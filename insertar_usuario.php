...
mysqli_query($datos_conexion, "INSERT INTO registro VALUES('$usuario_formu', '$clave_formu', '$nombre_formu', '$apellido_formu', $edad_formu, '$correo_formu', '$sitio_formu')");

$respuesta="Estimado/a: "."\r\n"."Le damos la bienvenida a nuestro sitio. ". "\r\n"."La informacion para ingresar en su cuenta es: ". "\r\n". "Usuario: ".$usuario_formu."\r\n"."Clave: ".$clave_formu;
